...
// MapMarker for clustering of google map markers
// https://pub.dev/packages/fluster & https://medium.com/coletiv-stories/how-to-cluster-markers-on-flutter-google-maps-44620f607de3
...
class MapMarker extends Clusterable {
  ...
  void Function(MapMarker)? callback;
...
class MapHelper {
  ...
  static Fluster<MapMarker> initClusterManager(
    ...
    return Fluster<MapMarker>(
      ...
      radius: 90,
      extent: 2048,
      /*IMPORTANT choose the maximum # of stores that can be posted in an area at the same time*/
      nodeSize: 1024,
      points: markers,
      createCluster: (
          BaseCluster? cluster,
          ...
          MapMarker(
            id: 'cluster${cluster!.id.toString()}',
